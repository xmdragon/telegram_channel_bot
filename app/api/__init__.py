...
from .training import router as training_api_router  # 训练API（尾部、分隔符、反馈）
...
api_router.include_router(training_api_router, prefix="/training", tags=["training-api"])  # 训练相关API，统一前缀
